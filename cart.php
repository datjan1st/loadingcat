...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><h4>".number_format($price, 0, '', '.')."</h4></td>";
		...
		echo "<td><strong><h3>".number_format($line_cost, 0, '', '.')."</h3></strong>";
		echo "</tr>";
		}
		...
		echo "<td><strong><input type='hidden' value='".$total."' required name='total'><h2 class='text-danger'>".number_format($total, 0, '', '.')."đ</h2></strong></td>";
		echo "<td></td>";
